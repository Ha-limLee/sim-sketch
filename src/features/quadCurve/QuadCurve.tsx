...
export const QuadCurve = ({ id, points, anchorPoint, stroke, strokeWidth, isDrawing, onAnchorDragEnd }: { id: string, points: number[], anchorPoint?: number[], stroke: string, strokeWidth?: number, isDrawing?: boolean, onAnchorDragEnd?: (anchor: number[]) => void}) => {
